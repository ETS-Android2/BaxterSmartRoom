    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (patientthisact >= 2) {
                    String pt1IDstr = snapshot.child("18").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 3) {
                    String pt1IDstr = snapshot.child("19").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 4) {
                    String pt1IDstr = snapshot.child("20").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 5) {
                    String pt1IDstr = snapshot.child("21").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 6) {
                    String pt1IDstr = snapshot.child("22").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 7) {
                    String pt1IDstr = snapshot.child("23").child("patientID").getValue().toString();
                ...
                if (patientthisact >= 8) {
                    String pt1IDstr = snapshot.child("24").child("patientID").getValue().toString();
