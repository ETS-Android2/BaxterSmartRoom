        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (Pumps >= 1) {
                    ...
                    Pump1drugstr = snapshot.child("9").child("drug").getValue().toString();
                    Pump1Ratestr = snapshot.child("9").child("currentRate").getValue().toString();
                    Pump1startVolumestr = snapshot.child("9").child("startVolume").getValue().toString();
                    Pump1Rate.setText(Pump1Ratestr);
                    Pump1drug.setText(Pump1drugstr);
                    pt1numberstr = snapshot.child("9").child("pumpnumber").getValue().toString();
                    pt1number.setText(pt1numberstr);
                    Pump1startVolume.setText(Pump1startVolumestr);
                    //data to pass on
                    alarm1 = snapshot.child("9").child("alarm").getValue().toString();
                    alarm_severity1 = snapshot.child("9").child("alarm_severity").getValue().toString();
                    Pump1ID = snapshot.child("9").child("pumpID").getValue().toString();
                    alarm_text1 = snapshot.child("9").child("alarm_text").getValue().toString();
                    //setting colors
                    String color1 = snapshot.child("9").child("alarm_severity").getValue().toString();
                ...
                if (Pumps >= 2) {
                    String pct1 = snapshot.child("10").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump2pct.setProgress(percent1);
                    pt2numberstr = snapshot.child("10").child("pumpnumber").getValue().toString();
                    pt2number.setText(pt2numberstr);
                    Pump2drugstr = snapshot.child("10").child("drug").getValue(String.class);
                    Pump2Ratestr = snapshot.child("10").child("currentRate").getValue().toString();;
                    Pump2startVolumestr = snapshot.child("10").child("startVolume").getValue().toString();
                    Pump2Rate.setText(Pump2Ratestr);
                    Pump2drug.setText(Pump2drugstr);
                    Pump2startVolume.setText(Pump2startVolumestr);
                    alarm2 = snapshot.child("10").child("alarm").getValue().toString();;
                    alarm_severity2 = snapshot.child("10").child("alarm_severity").getValue().toString();;
                    Pump2ID = snapshot.child("10").child("pumpID").getValue().toString();;
                    alarm_text2 = snapshot.child("10").child("alarm_text").getValue(String.class);
                    String color2 = snapshot.child("10").child("alarm_severity").getValue().toString();
                ...
                if (Pumps >= 3){
                    String pct1 = snapshot.child("11").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump3pct.setProgress(percent1);
                    pt3numberstr = snapshot.child("11").child("pumpnumber").getValue().toString();
                    pt3number.setText(pt3numberstr);

                    Pump3drugstr = snapshot.child("11").child("drug").getValue(String.class);
                    Pump3Ratestr = snapshot.child("11").child("currentRate").getValue().toString();;
                    Pump3startVolumestr = snapshot.child("11").child("startVolume").getValue().toString();
                    Pump3Rate.setText(Pump3Ratestr);
                    Pump3drug.setText(Pump3drugstr);
                    Pump3startVolume.setText(Pump3startVolumestr);
                    alarm3 = snapshot.child("11").child("alarm").getValue().toString();;
                    alarm_severity3 = snapshot.child("11").child("alarm_severity").getValue().toString();;
                    Pump3ID = snapshot.child("11").child("pumpID").getValue().toString();;
                    alarm_text3 = snapshot.child("11").child("alarm_text").getValue(String.class);
                    String color3 = snapshot.child("11").child("alarm_severity").getValue().toString();
                ...
                if (Pumps >= 4){
                    String pct1 = snapshot.child("12").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump4pct.setProgress(percent1);
                    String Pump4drugstr = snapshot.child("12").child("drug").getValue(String.class);
                    String Pump4Ratestr = snapshot.child("12").child("currentRate").getValue().toString();
                    String Pump4startVolumestr = snapshot.child("12").child("startVolume").getValue().toString();
                    Pump4Rate.setText(Pump4Ratestr);
                    Pump4drug.setText(Pump4drugstr);
                    pt4numberstr = snapshot.child("12").child("pumpnumber").getValue().toString();
                    pt4number.setText(pt4numberstr);
                    Pump4startVolume.setText(Pump4startVolumestr);
                    alarm4 = snapshot.child("12").child("alarm").getValue().toString();;
                    alarm_severity4 = snapshot.child("12").child("alarm_severity").getValue().toString();;
                    Pump4ID = snapshot.child("12").child("pumpID").getValue().toString();;
                    alarm_text4 = snapshot.child("12").child("alarm_text").getValue(String.class);
                    String color4 = snapshot.child("12").child("alarm_severity").getValue().toString();
                ...
                if (Pumps >= 5){
                    String pct1 = snapshot.child("13").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump5pct.setProgress(percent1);
                    pt5numberstr = snapshot.child("13").child("pumpnumber").getValue().toString();
                    pt5number.setText(pt2numberstr);
                    String color5 = snapshot.child("13").child("alarm_severity").getValue().toString();
                    ...
                    Pump5drugstr = snapshot.child("13").child("drug").getValue(String.class);
                    Pump5Ratestr = snapshot.child("13").child("currentRate").getValue().toString();;
                    Pump5startVolumestr = snapshot.child("13").child("startVolume").getValue().toString();
                    Pump5Rate.setText(Pump5Ratestr);
                    Pump5drug.setText(Pump5drugstr);
                    Pump5startVolume.setText(Pump5startVolumestr);
                    alarm5 = snapshot.child("13").child("alarm").getValue().toString();;
                    alarm_severity5 = snapshot.child("13").child("alarm_severity").getValue().toString();;
                    Pump5ID = snapshot.child("13").child("pumpID").getValue().toString();;
                    alarm_text5 = snapshot.child("13").child("alarm_text").getValue(String.class);
                }
                if (Pumps >= 6) {
                    String pct1 = snapshot.child("14").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump6pct.setProgress(percent1);
                    String color6 = snapshot.child("14").child("alarm_severity").getValue().toString();
                    ...
                    pt6numberstr = snapshot.child("14").child("pumpnumber").getValue().toString();
                    pt6number.setText(pt6numberstr);
                    Pump6drugstr = snapshot.child("14").child("drug").getValue(String.class);
                    Pump6Ratestr = snapshot.child("14").child("currentRate").getValue().toString();;
                    Pump6startVolumestr = snapshot.child("14").child("startVolume").getValue().toString();
                    Pump6Rate.setText(Pump6Ratestr);
                    Pump6drug.setText(Pump6drugstr);
                    Pump6startVolume.setText(Pump6startVolumestr);
                    alarm6 = snapshot.child("14").child("alarm").getValue().toString();;
                    alarm_severity6 = snapshot.child("14").child("alarm_severity").getValue().toString();;
                    Pump6ID = snapshot.child("14").child("pumpID").getValue().toString();;
                    alarm_text6 = snapshot.child("14").child("alarm_text").getValue(String.class);
                }
                if (Pumps >= 7){
                    String pct1 = snapshot.child("15").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump7pct.setProgress(percent1);
                    pt7numberstr = snapshot.child("15").child("pumpnumber").getValue().toString();
                    pt7number.setText(pt7numberstr);
                    String color7 = snapshot.child("15").child("alarm_severity").getValue().toString();
                    ...
                    Pump7drugstr = snapshot.child("15").child("drug").getValue(String.class);
                    Pump7Ratestr = snapshot.child("15").child("currentRate").getValue().toString();;
                    Pump7startVolumestr = snapshot.child("15").child("startVolume").getValue().toString();
                    Pump7Rate.setText(Pump7Ratestr);
                    Pump7drug.setText(Pump7drugstr);
                    Pump7startVolume.setText(Pump7startVolumestr);
                    alarm7 = snapshot.child("15").child("alarm").getValue().toString();;
                    alarm_severity7 = snapshot.child("15").child("alarm_severity").getValue().toString();;
                    Pump7ID = snapshot.child("15").child("pumpID").getValue().toString();;
                    alarm_text7 = snapshot.child("15").child("alarm_text").getValue(String.class);
                    Pump7.setEnabled(true);
                    Pump7.setVisibility(View.VISIBLE);

                }
                if (Pumps >= 8) {
                    String pct1 = snapshot.child("16").child("percent_complete").getValue().toString();
                    int percent1 = Integer.parseInt(pct1);
                    Pump8pct.setProgress(percent1);
                    pt8numberstr = snapshot.child("16").child("pumpnumber").getValue().toString();
                    pt8number.setText(pt8numberstr);
                    String color8 = snapshot.child("16").child("alarm_severity").getValue().toString();
                    ...
                    Pump8drugstr = snapshot.child("16").child("drug").getValue(String.class);
                    Pump8Ratestr = snapshot.child("16").child("currentRate").getValue().toString();;
                    Pump8startVolumestr = snapshot.child("16").child("startVolume").getValue().toString();
                    Pump8Rate.setText(Pump8Ratestr);
                    Pump8drug.setText(Pump8drugstr);
                    Pump8startVolume.setText(Pump8startVolumestr);
                    alarm8 = snapshot.child("16").child("alarm").getValue().toString();;
                    alarm_severity8 = snapshot.child("16").child("alarm_severity").getValue().toString();;
                    Pump8ID = snapshot.child("16").child("pumpID").getValue().toString();;
                    alarm_text8 = snapshot.child("16").child("alarm_text").getValue(String.class);
