...
public class PatientActivity2 extends AppCompatActivity {
    ...
    String name, pt1pump,pt2pump,pt3pump,pt4pump,pt5pump,pt6pump,pt7pump,pt8pump, room, user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String pt1pump = snapshot.child("1").child("pump").getValue(String.class);
                ...
                String pt2pump = snapshot.child("2").child("pump").getValue(String.class);
                ...
                String pt3pump = snapshot.child("3").child("pump").getValue(String.class);
                ...
                String pt4pump = snapshot.child("4").child("pump").getValue(String.class);
                ...
                String pt5pump = snapshot.child("5").child("pump").getValue(String.class);
                ...
                String pt6pump = snapshot.child("6").child("pump").getValue(String.class);
                ...
                String pt7pump = snapshot.child("7").child("pump").getValue(String.class);
                ...
                String pt8pump = snapshot.child("8").child("pump").getValue(String.class);
    ...
    private void clickListen() {
        Patient1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PatientActivity2.this, PumpActivity1.class);
                intent.putExtra("name", name);
                intent.putExtra("user",user);
                intent.putExtra("pump",pt1pump);
        ...
        Patient2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("name", name);
                intent.putExtra("user",user);
                intent.putExtra("pump",pt8pump);
                intent.putExtra("room","8");
                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                finish();
            }
